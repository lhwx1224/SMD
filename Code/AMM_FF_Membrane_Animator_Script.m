...
ReadSystem = 1;                                % Read System Matrix
%%
if ~ReadSystem
...
mm = 20;            % Number of eigenfunctions used in the x direction
nn = 20;            % Number of eigenfunctions used in the y direction
...
tend = 30;                           % ending time of simulation
...
subplot(311)
yyaxis left
plot(real(Phi_x(:,ModeIndices))), hold on
yyaxis right
plot((real(y_am(1,:))))
subplot(312)
plot(abs(eta_am(1,1:2:size(eta_am))),'o')
set(gca,'yscale','log')
